...
park_hours = {
    ...
    "Universal Studios": "8:00 AM - 10:00 PM",
...
def index():
    ...
    return render_template_string(MAIN_TEMPLATE, playlist=playlist, top_5=top_5, hours=park_hours, ai_tips=ai_suggestions)
...
<html>
<head>
    <title>WDW Today - Gemini Integrated</title>
